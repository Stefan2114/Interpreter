...
public class Main {
    ...
    public static void main(String[] args) throws EmptyStackException, StatementException, ControllerException, KeyNotFoundException, ExpressionException, RepoException {
        ...
        PrgState prg1 = new PrgState(st1, new MyStack<IStatement>(), new MyMap<String, IValue>(), new MyList<String>(), new MyMap<StringValue, BufferedReader>());
        ...
        PrgState prg2 = new PrgState(st2, new MyStack<IStatement>(), new MyMap<String, IValue>(), new MyList<String>(), new MyMap<StringValue, BufferedReader>());
        ...
        PrgState prg3 = new PrgState(st3, new MyStack<IStatement>(), new MyMap<String, IValue>(), new MyList<String>(), new MyMap<StringValue, BufferedReader>());
        ...
        PrgState prg4 = new PrgState(st4, new MyStack<IStatement>(), new MyMap<String, IValue>(), new MyList<String>(), new MyMap<StringValue, BufferedReader>());
